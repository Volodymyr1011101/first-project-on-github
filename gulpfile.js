...
gulp.task('styles', (done) => {
  runSequence('styles:inject', 'styles:checked', 'styles:compile', 'styles:prefix', done);
});
...
gulp.task('watch', () => {
  gulp.watch([
    ...
    let tasks = ['styles:checked', 'styles:compile', 'bs:reload-css'];
...
gulp.task('default', (done) => {
  runSequence(
    'styles:inject',
    ['scripts:concat', 'styles:checked', 'styles:compile', 'bs:init', 'watch'],
    done
  );
});
